...
function buildRouting (options) {
  ...
  return {
    ...
    setup (options, fastifyArgs) {
      ...
      trackKeepAliveConnections = fastifyArgs.trackKeepAliveConnections
  ...
  function routeHandler (req, res, params, context, query) {
    ...
    // Track keep-alive sockets only when shutdown depends on our own container.
    if (trackKeepAliveConnections === true) {
