...
function buildRouting (options) {
  ...
  function routeHandler (req, res, params, context, query) {
    ...
    if (closing === true) {
      ...
      // Node 19+ closes idle keep-alive connections during server.close(),
      // but requests can still reach this path on active or pipelined
      // connections. return503OnClosing defines Fastify's behavior there.
