...
function createServer (options, httpHandler) {
  ...
  const trackKeepAliveConnections = !serverHasCloseAllConnections && forceCloseConnections === true
  const keepAliveConnections = trackKeepAliveConnections ? new Set() : noopSet()
